...
.card {
    box-shadow: 0 27px 21px 0 rgb(0 0 0 / 20%);
    max-width: 300px;
    /* margin: auto; */
    text-align: center;
    display: inline-grid;
...
<br>
 ...
 <br><br><br>
        <form method="POST">
            <div  style= "    display: block; align-items: center; text-align: center;  width: 500px; height: 500px; margin-left: 36%; background-color: #A5CFE3; " class="loginf">
