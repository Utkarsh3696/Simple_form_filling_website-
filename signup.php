...
?>
 ...
 <br>
        <form method="POST" >
            <div  style= "    display: block; align-items: center; text-align: center;  width: 500px; height: 730px; margin-left: 36%; background-color: #A5CFE3;     margin-top: -36px; " class="loginf">
